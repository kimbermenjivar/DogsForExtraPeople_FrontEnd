...
var onAddDog = function onAddDog(event) {
  event.preventDefault();
  var data = getFormFields(this); // this === event.target
  api.addDogs(data).then(ui.addDogSuccess).then(function () {
    $('#add-dog')[0].reset();
...
var onUpdateDog = function onUpdateDog(event) {
  ...
  api.updateDog(data).then(ui.updateDogSuccess).then(function () {
    $('#update-dog-form')[0].reset();
  }).catch(ui.updateDogFailure);
};

var onDeleteDogs = function onDeleteDogs(event) {
  event.preventDefault();
  var data = getFormFields(this); // this === event.target
  api.deleteDog(data).then(ui.deleteDogSuccess).catch(ui.deleteDogFailure);
};

var onSearchForDogs = function onSearchForDogs(event) {
  clearTMP();
  event.preventDefault();
  //   console.log('Search for Dog ran!')
  api.searchForDogs().then(ui.searchForDogsSuccess).catch(ui.searchForDogsFailure);
};
...
var addDogs = function addDogs(data) {
  //   console.log('data is ', data)
  return $.ajax({
...
var deleteDog = function deleteDog(data) {
  //   console.log('data is ', data)
...
var searchForDogs = function searchForDogs() {
  return $.ajax({
    url: config.apiUrl + '/dogs/',
    method: 'GET',
    headers: {
...
var updateDog = function updateDog(data) {
  return $.ajax({
    url: config.apiUrl + '/dogs/' + data.dog.id,
    method: 'PATCH',
    headers: {
...
var apiUrl = void 0;
var apiUrls = {
  production: 'https://sheltered-hollows-32763.herokuapp.com',
...
var addDogSuccess = function addDogSuccess() {
...
var updateDogSuccess = function updateDogSuccess() {
  $('#message').text('Updated dog');
  $('#message').css('background-color', 'green');
  // console.log('Updated Dog')
};
var searchForDogsSuccess = function searchForDogsSuccess(data) {
  $('.search-results').html('');
  var searchHTML = '';
...
var updateDogFailure = function updateDogFailure() {
  $('#message').text('This is not your dog!');
  $('#message').css('background-color', 'red');
  //   console.log('updateFailure ran. Data is:', error)
};

var deleteDogSuccess = function deleteDogSuccess(data) {
  $('#message').text('Deleted Successfully');
  $('#message').css('background-color', 'green');
  $('#delete-dog')[0].reset();
};

var deleteDogFailure = function deleteDogFailure() {
  $('#message').text('This is not your DOG!');
  $('#message').css('background-color', 'red');
};

var addDogsFailure = function addDogsFailure() {
...
module.exports = {
  ...
  addDogSuccess: addDogSuccess,
  addDogsFailure: addDogsFailure,
  searchForDogsSuccess: searchForDogsSuccess,
  deleteDogSuccess: deleteDogSuccess,
  deleteDogFailure: deleteDogFailure,
  updateDogSuccess: updateDogSuccess,
  updateDogFailure: updateDogFailure
};
/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(0)))
